...
import { ImportLocalAgentsButton } from './components'
...
const PublisherPage = async ({ params }: PublisherPageProps) => {
  ...
  const importPermission = await checkPublisherPermission(publisherData.id)
  const canImportLocalAgents = importPermission.success
              ...
              <div className="flex-1 min-w-0">
                <div className="flex flex-col sm:flex-row sm:items-center gap-2 mb-2">
                  <div className="flex flex-col sm:flex-row sm:items-center gap-2 flex-1">
                    ...
                    {canImportLocalAgents ? (
                      <div className="sm:ml-auto">
                        <ImportLocalAgentsButton
